...
export default function ProjectList() {
    ...
    const projects = [
        ...
        { id: 11, name: "School Management System", icon: <School className="w-8 h-8 text-yellow-500" />, type: "type1" },
         { id: 12, name: "Online Store / Dropshipping Website", icon: <ShoppingCart className="w-8 h-8 text-pink-500" />, type: "type1" },
        ...
        { id: 6, name: "Consignment Website / Shipping", icon: <Briefcase className="w-8 h-8 text-teal-500" />, type: "type2" },

        { id: 14, name: "Crypto Investment Website", icon: <Wallet className="w-8 h-8 text-purple-400" />, type: "type2" },
        { id: 2, name: "Loan Management Website", icon: <Building className="w-8 h-8 text-green-500" />, type: "type2" },
            ...
            <main className="py-20">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <h1 className="text-3xl font-bold  text-foreground">Website We Build</h1>
                        ...
                        >
                            <option value="type1">Legit Website</option>
                            <option value="type2">Fraudulent Website</option>
                        </select>
                    </div>
